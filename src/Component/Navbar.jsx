    ...
    return(
        ...
        <nav id="nav" onClick={handleClickAway} className={` duration-500 ease-in ${togglebar ? 'bg-lime-400 w-full p-3 pt-0 z-40 text-base absolute' 
            ...
            <ul>
                ...
                <li>
                <Link to="/Profile" className="flex items-center text-lg xl:text-2xl pb-2 text-violet-950 hover:duration-150 hover:font-extrabold hover:text-lime-50">
                ...
                <li>
                <Link to="/GoalsDay" className="flex items-center text-lg xl:text-2xl pb-2 text-violet-950 hover:duration-150 hover:font-extrabold hover:text-lime-50">
                ...
                <li>
                    <Link to="/Calendar" className="flex items-center text-lg xl:text-2xl pb-2 text-violet-950 hover:duration-150 hover:font-extrabold hover:text-lime-50">
