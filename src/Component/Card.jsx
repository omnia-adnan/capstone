...
return (
        <div className="flex h-82 m-[2%] rounded-3xl text-white bg-blue-900 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
            ...
            <h3 className="mb-2 3xl:mb-8 text-xl 3xl:text-8xl font-thin leading-tight">{title}</h3>
            <p className="mb-2 3xl:mb-8 text-sm 3xl:text-5xl font-thin">{description}</p>
            ...
            <img src={img3} alt="carcter" className="bg-cover size-[20%] p-1"/>
        </div>
    );
};